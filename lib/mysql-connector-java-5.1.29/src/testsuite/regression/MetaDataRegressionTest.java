...
public class MetaDataRegressionTest extends BaseTestCase {
	...
	public void testBug8800() throws Exception {
		assertEquals(
				((Connection) this.conn).lowerCaseTableNames(),
	...
	public void testBug9769() throws Exception {
		boolean defaultPatternConfig = ((Connection) this.conn)
	...
	public void testBug9917() throws Exception {
		...
		boolean defaultCatalogConfig = ((Connection) this.conn)
	...
	public void testBug11781() throws Exception {
		 ...
		 * null, "app tab");
		 */
		this.rs = ((DatabaseMetaData) this.conn.getMetaData())
	...
	private void checkRsmdForBug13277(ResultSetMetaData rsmd)
		...
		int i = ((ConnectionImpl) this.conn)
				.getMaxBytesPerChar(((ConnectionImpl) this.conn)
	...
	private void testBug65871_testTable(
		...
		try {
			...
			if (!(versionMeetsMinimum(5, 1) && !versionMeetsMinimum(5, 2))) {
				try {
					this.rs = ((DatabaseMetaData) conn1.getMetaData()).extractForeignKeyFromCreateTable(unquotedDbName, unquotedTableName);
					if (!this.rs.next()) {

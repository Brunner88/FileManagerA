...
public class ConnectionTest extends BaseTestCase {
	...
	public void testDumpQueriesOnException() throws Exception {
		...
		try {
			((Connection) dumpConn).clientPrepareStatement(
	...
	public void testLocalInfileWithUrl() throws Exception {
		...
		String charset = " CHARACTER SET " + CharsetMapping.getMysqlEncodingForJavaEncoding(((MySQLConnection)loadConn).getEncoding(), (Connection) loadConn);
	...
	public void testSetProfileSql() throws Exception {
		((Connection) this.conn).setProfileSql(false);
		stmt.executeQuery("SELECT 1");
		((Connection) this.conn).setProfileSql(true);
		stmt.executeQuery("SELECT 1");
	}
	...
	private void testInterfaceImplementation(Connection connToCheck)
		...
		pStmtToCheck = ((Connection) connToCheck)
	...
	public void testIsLocal() throws Exception {
		...
		if (host.equals("localhost") || host.equals("127.0.0.1")) {
			...
			assertTrue(((ConnectionImpl) this.conn).isServerLocal());
		}
